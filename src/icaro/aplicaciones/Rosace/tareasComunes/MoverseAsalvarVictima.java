 ...
 * @author FGarijo
 */
public class MoverseAsalvarVictima extends TareaAsincrona {
...
//                            + " Los objetivos en la cola son  :  " + misObjs.getMisObjetivosPriorizados() + "\n");
                    System.out.println("\n" + identAgente + "Se ejecuta la tarea " + getIdentTarea() + " Se inicia el movimiento hacia para salvar a la victima :  " + victima + "\n\n");
                }
